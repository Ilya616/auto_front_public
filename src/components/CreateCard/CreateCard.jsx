...
import ColorMenu from "@uiComponents/ColorMenu/ColorMenu";
        ...
        <div>
          {step == 0 && (
            <div>
              ...
              <select onChange={changeMarka}>
                <option key="0" disabled defaultValue="0">
                  Выберите марку
                </option>
          ...
          {step == 1 && (
            <div>
              ...
              <Button event={handleNextStep}>Далее</Button>
            </div>
          )}
        </div>
      ) : (
