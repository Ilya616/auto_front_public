    ...
    <article className={styles.container}>
      <div>
        ...
        <form onSubmit={onAuthRequest}>
          <input onChange={onChangeEmail} name="email" placeholder="email" />
          <br />
...

          {
            <button
              disabled={
                authUser.email === null || authUser.password === null
                  ? true
                  : false
              }
            >
      ...
      <div>
        ...
        <form onSubmit={onRegistrationRequest}>
          ...
          <input onChange={onChangeRegEmail} placeholder="email" />
          <br />
...

          {
            <button
              disabled={
                registrationUser.password === null ||
